      ...
      <div className={props.style}>
        <div className="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden">
          ...
          <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-6 lg:px-6">
            <h1 className="text-5xl font-medium uppercase p-3 pb-0 text-center text-gray-500 tracking-wide">
              {props.unidade}
            </h1>
          ...
          <div className="flex flex-wrap mt-3 px-6 justify-center items-center">
            ...
            <img
              className="inline-block sm:w-30 sm:h-32   w-30 h-32 rounded-full ring-white"
              src="/img/etiquetaLogo.png"
              alt="imagem de adesivo redondo"
            />
          </div>
          ...
          <div className="block flex items-center  uppercase">
            <a
              className="text-center mt-3 text-lg font-semibold bg-black w-full text-white rounded-lg px-6 py-3 block shadow-xl bg-green-400 hover:bg-green-500"
