...
const Landing = () => {
    return (
        <div style={{backgroundImage: "url('/img/granola.jpg')", backgroundSize:"900px", backgroundRepeat:"no-repeat", backgroundPosition:"center", backgroundAttachment:"fixed"}}>
        <section> 
              ...
              <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-mr-4">
                ...
                <div className="text-sm leading-none rounded-t-lg bg-gray-200 text-black font-semibold uppercase py-4 text-center tracking-wide">
                  ...
                  <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                    <h1 className="text-4xl font-medium uppercase p-3 pb-0 text-center text-green-400 tracking-wide">
                      245
                    </h1>
      ...
      >
          ...
          ></polyline>
                  ...
                  <img className="inline-block w-32 rounded-full ring-white ml-10" src="/img/etiquetaLogo.png" alt=""/>
                  </div>
                  
                  <h2 className="text-3xl font-medium uppercase p-3 pb-0 text-center tracking-wide text-green-500 ">
                      R$91,00
                    </h2>
          ...
          px-6 py-3 block shadow-xl bg-green-400 hover:bg-green-500">
          Comprar já!
      </button>
                  </div>
                </div>
      ...
      <footer className="pt-4">
        ...
        <span className="text-center font-sans border-b-2 border-blue-200 hover:text-blue-200">@framansi  </span>
          <svg className="h-5 px-2 cursor-pointer fill-current text-blue-200 hover:text-blue-300" viewBox="0 0 30 24" xmlns="http://www.w3.org/2000/svg">
